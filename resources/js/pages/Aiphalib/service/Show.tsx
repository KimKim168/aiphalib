...
const Show = () => {
    const { service, relatedServices } = usePage().props;

    return (
        <AiphalibLayout>
            <div className="mx-auto my-10 grid max-w-screen-2xl flex-col gap-6 px-4 sm:px-10 lg:grid-cols-3 xl:px-20">
                <div className="prose flex min-h-[200px] w-full max-w-none items-center justify-center text-center lg:col-span-2">
